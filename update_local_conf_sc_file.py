...
new_lines.append('SQUEEZECENTER_SCM = "git:///home/squeezeos/poky/sources/git/github.com.ralph-irving.slimserver.git;protocol=file;branch=public/9.1"\n')
new_lines.append('SRCREV_pn-squeezecenter = "4967db209310c083db57f70d94e90802d655e973"\n')

with open(conf_path, 'w') as f:
    f.writelines(new_lines)

print("Successfully injected SQUEEZECENTER_SCM local file protocol override")
